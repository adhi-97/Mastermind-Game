/*
 * Problem Statement #2: MasterMind Game Using SAT Solver (with Repetition of colours).
...
int main(){
    ...
    //Constraint 1 : No 2 Colour should be present at the same Position.
    for(int i=1;i<=28;i++){
    ...
    //Constraint 2 : Atleast 4 Colour should be present in the output of SAT Solver. 
    for(int i=1;i<=4;i++){
        clause.push_back(i);
